...
`sed` (**s**tream **ed**itor) has several commands, but the most used one is the substitute command which changes the regular expression occurrences into new values.
